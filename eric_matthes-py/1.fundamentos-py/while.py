...
## Transferindo dados de uma lista para outra utilizando o while
...
## Removendo todas as instancias de uma lista com o while
...
## Armazenando dados de um input em um dicionario
